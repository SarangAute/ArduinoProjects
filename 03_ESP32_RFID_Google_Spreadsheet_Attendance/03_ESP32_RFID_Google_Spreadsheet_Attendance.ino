...
const char* ssid = "realme 9 Pro 5G";  //--> Your wifi name
const char* password = "Rushi@03"; //--> Your wifi password
//----------------------------------------

// Google script Web_App_URL.
String Web_App_URL = "https://script.google.com/macros/s/AKfycbx1KQaQiYs2_HZGTTwIb_S2ouRcdH82NoDLmgBeuO_ojG2jYqh3vDYr6rRcf56pPcs/exec";
